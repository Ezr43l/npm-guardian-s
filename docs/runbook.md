...
3. verifica `1.0.4`, vista reducida, secretos, huella topológica, NPM y receptor;
...
los pasivos antes del activo. Una referencia `:1.0.4` debe llevar metadatos OCI
`1.0.4` y responder lo mismo en `/api/version`.

La versión no se publica en el repositorio compartido ni recibe el tag `v1.0.4` hasta
